...
var EventCell = _react2.default.createClass({
  ...
  render: function render() {
    ...
    var props = _objectWithoutProperties(_props, ['className', 'event', 'selected', 'eventPropGetter', 'startAccessor', 'endAccessor', 'titleAccessor', 'colorAccessor', 'slotStart', 'slotEnd', 'onSelect', 'component']);

    var Component = component;

    var title = (0, _accessors.accessor)(event, titleAccessor),
        color = (0, _accessors.accessor)(event, colorAccessor),
    ...
    return _react2.default.createElement(
      'div',
      {
        style: _extends({}, props.style, style, { backgroundColor: color }),
