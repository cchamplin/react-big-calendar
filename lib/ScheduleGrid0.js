...
var ScheduleGridOld = function (_Component) {
  _inherits(ScheduleGridOld, _Component);

  function ScheduleGridOld(props) {
    _classCallCheck(this, ScheduleGridOld);
  ...
  ScheduleGridOld.prototype.componentWillMount = function componentWillMount() {
    this._gutters = [];
    this.calculateScroll();
  };

  ScheduleGridOld.prototype.componentDidMount = function componentDidMount() {
    this.checkOverflow();
  ...
  ScheduleGridOld.prototype.componentWillUnmount = function componentWillUnmount() {
    window.clearTimeout(this._timeIndicatorTimeout);
  };

  ScheduleGridOld.prototype.componentDidUpdate = function componentDidUpdate() {
  ...
  ScheduleGridOld.prototype.componentWillReceiveProps = function componentWillReceiveProps(nextProps) {
  ...
  ScheduleGridOld.prototype.render = function render() {
    var _this2 = this;
    ...
    final.forEach(function (period) {
      if (r(period, start, end, _this2.props)) {
    ...
    var segments = finalSchedule.map(function (evt) {
      return scheduledEventSegments(evt, first, last, _this2.props);
    });
    ...
    return _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(_ScheduleColumn2.default, _extends({}, this.props, {
          showLabels: true,
          style: { width: width },
          ref: gutterRef,
  ...
  ScheduleGridOld.prototype.renderSchedule = function renderSchedule(range, events, today) {
    var _this3 = this;
    ...
    return range.map(function (date, idx) {
      ...
      return _react2.default.createElement(_ScheduleDayColumn2.default, _extends({}, _this3.props, {
  ...
  ScheduleGridOld.prototype.renderFinalSchedule = function renderFinalSchedule(range, levels) {
    var _this4 = this;
  ...
  ScheduleGridOld.prototype.renderHeader = function renderHeader(range, segments, width) {
    var _this5 = this;
  ...
  ScheduleGridOld.prototype.renderHeaderCells = function renderHeaderCells(range) {
    var _this6 = this;
  ...
  ScheduleGridOld.prototype._headerClick = function _headerClick(date, e) {
    e.preventDefault();
    (0, _helpers.notify)(this.props.onNavigate, [_constants.navigate.DATE, date]);
  };

  ScheduleGridOld.prototype._selectEvent = function _selectEvent() {
  ...
  ScheduleGridOld.prototype.measureGutter = function measureGutter() {
  ...
  ScheduleGridOld.prototype.applyScroll = function applyScroll() {
  ...
  ScheduleGridOld.prototype.calculateScroll = function calculateScroll() {
  ...
  ScheduleGridOld.prototype.checkOverflow = function checkOverflow() {
    var _this7 = this;
  ...
  return ScheduleGridOld;
}(_react.Component);

ScheduleGridOld.propTypes = _extends({}, _ScheduleDayColumn2.default.propTypes, _ScheduleColumn2.default.propTypes, {
...
ScheduleGridOld.defaultProps = _extends({}, _ScheduleDayColumn2.default.defaultProps, _ScheduleColumn2.default.defaultProps, {
...
exports.default = ScheduleGridOld;
