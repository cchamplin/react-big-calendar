...
var _ScheduleSlot = require('./ScheduleSlot');

var _ScheduleSlot2 = _interopRequireDefault(_ScheduleSlot);
...
var ScheduleSlotGroup = function (_Component) {
  ...
  ScheduleSlotGroup.prototype.renderSlice = function renderSlice(slotNumber, content, value) {
    ...
    return _react2.default.createElement(_ScheduleSlot2.default, { key: slotNumber,
