...
var ScheduleGrid = function (_Component) {
  ...
  ScheduleGrid.prototype.renderEvents = function renderEvents(range, events, today) {
    var _this3 = this;
  ...
  ScheduleGrid.prototype.renderAllDayEvents = function renderAllDayEvents(range, levels) {
    var _this4 = this;
  ...
  ScheduleGrid.prototype.positionTimeIndicator = function positionTimeIndicator() {
  ...
  ScheduleGrid.prototype.triggerTimeIndicatorUpdate = function triggerTimeIndicatorUpdate() {
    var _this8 = this;
...
ScheduleGrid.propTypes = _extends({}, _DayColumn2.default.propTypes, _ScheduleColumn2.default.propTypes, {
...
ScheduleGrid.defaultProps = _extends({}, _DayColumn2.default.defaultProps, _ScheduleColumn2.default.defaultProps, {
